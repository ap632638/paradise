<%-- 
    Document   : lgheader
    Created on : 9 Oct, 2019, 12:54:19 AM
    Author     : Arun
--%>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li class="active"><a href="stuportal.jsp">Home</a></li>            
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Courses <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="/paradise/video">Video Courses</a></li>                
                <li><a href="pdfcourse.jsp">Pdf Courses</a></li>                
              </ul>
            </li>           
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="/paradise/viewresult">View Result</a></li>                
