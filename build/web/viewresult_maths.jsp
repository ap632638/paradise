<%-- 
    Document   : viewresult_maths
    Created on : 11 Oct, 2019, 9:01:32 AM
    Author     : Arun
--%>
...
<div class="rslt">
        <table border="1px"style="text-align: center; border-collapse: collapse; height: 500px;" align="center" id="rslt" class="table table-bordered  table-responsive m-auto text-center tmain">
                        <thead>
                                <tr>
                                        <td colspan="2">
    ...
    float: left;"/ ></span><h3 style="font-size: 35px;"><%  
                        ...
                        <tbody>
                                <tr>
                                        <td colspan="2">
                                                <table border="1px"style="text-align: center; border-collapse: collapse; width:100%;" class="table table-bordered table-responsive table-hover m-auto text-center tsub1">
                                                        <thead>
                                                                <tr>
                                ...
                                <tr>
                                        <td colspan="2">
                                                <table border="1px"style="text-align: center; border-collapse: collapse; width:100%;" class="table table-bordered table-responsive table-hover tsub1">
                                                        <thead>
                                                                <tr>
                                                                        <th>
                                                                                Subject
