<%-- 
    Document   : login_fail
    Created on : 8 Oct, 2019, 11:37:28 PM
    Author     : Arun
--%>
...
<%@include file="header.jsp" %>
 ...
 <table  align="center" class="table table-borderless table-condensed table-hover mt-5">
     <form method="post" action="/paradise/login" >
         <thead>
             <tr><td colspan="2"><h3 class="text-center">Student Login</h3></td></tr>
         </thead>
         <tbody>
            <tr>
                <input type="text" value="1" name="opt" hidden="true">
                <td><label>Username</label></td>
                <td><input type="text" class="form-control" name="uname" id="uname" autofocus="on" placeholder="Enter email or student id"/></td>
            </tr>
            <tr>
