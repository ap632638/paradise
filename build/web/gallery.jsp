<%-- 
    Document   : gallery
    Created on : 3 Oct, 2019, 11:12:33 PM
    Author     : Arun
--%>
       ...
       <div class="col-md-12">
         <div class="mu-gallery-area">
          ...
          <div class="mu-gallery-content">
            ...
            <%
                ResultSet x=(ResultSet)request.getAttribute("photo");
                while(x.next())
                {
            ...
            <li class="col-md-4 col-sm-6 col-xs-12 mix <% out.println(x.getString("img_type"));%>">
                  <div class="mu-single-gallery">                  
                    <div class="mu-single-gallery-item">
                      <div class="mu-single-gallery-img">
                          <a href="#"><img alt="img" src="/paradise/<% out.print(x.getString("path"));%>"></a>
                      </div>
