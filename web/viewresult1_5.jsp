<%-- 
    Document   : viewresult
    Created on : 10 Oct, 2019, 11:44:30 AM
    Author     : Arun
--%>
...
<div class="rslt">
        <table border="1px"style="text-align: center; border-collapse: collapse; height: 500px;" align="center" id="rslt" class="table table-bordered  m-auto text-center tmain">
                        <thead>
                                <tr>
                                        <td colspan="2">
                                            <span><img src="assets\img\school_logo.JPG" style=" width: 135px;
    height: 100px;
    float: left;"/ ></span><h3 style="font-size: 35px;">Paradise Public School</h3>
                                        </td>
                                </tr>
                        </thead>
                        <tbody>
                                                ...
                                                <table border="1px"style="text-align: center; border-collapse: collapse; width:100%;" class="table table-bordered table-hover tsub1">
                                                        ...
                                                        <tbody>
                                                                <tr>
                                                                        ...
                                                                        <td>100</td>
                                                                        <td><% out.println(rs.getString("mathematics")); %></td>
                                                                        <td><% 
                                                                            if(Integer.parseInt(rs.getString("mathematics"))>74)
                                                                            {
                                                                                out.println("DISTN");
                                                                            }
                                                                            else{
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td>100</td>
                                                                        <td><% out.println(rs.getString("enviromental_studies")); %></td>
                                                                        <td>
                                                                            <% 
                                                                            if(Integer.parseInt(rs.getString("enviromental_studies"))>74)
                                                                            {
                                                                                out.println("DISTN");
                                                                            }
                                                                            else{
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td>100</td>
                                                                        <td><% out.println(rs.getString("english")); %></td>
                                                                        <td>
                                                                            <% 
                                                                            if(Integer.parseInt(rs.getString("english"))>74)
                                                                            {
                                                                                out.println("DISTN");
                                                                            }
                                                                            else{
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td>100</td>
                                                                        <td><% out.println(rs.getString("hindi")); %></td>
                                                                        <td>
                                                                            <% 
                                                                            if(Integer.parseInt(rs.getString("hindi"))>74)
                                                                            {
                                                                                out.println("DISTN");
                                                                            }
                                                                            else{
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td>100</td>
                                                                        <td><% out.println(rs.getString("computer")); %></td>
                                                                        <td>
                                                                            <% 
                                                                            if(Integer.parseInt(rs.getString("computer"))>74)
                                                                            {
                                                                                out.println("DISTN");
                                                                            }
                                                                            else{
                                                        ...
                                                        <tfoot>
                                                                <tr>
                                                                        ...
                                                                        <th>500</th>
                                                                        <th><% 
                                                                            int tot=Integer.parseInt(rs.getString("mathematics"))+Integer.parseInt(rs.getString("enviromental_studies"))+Integer.parseInt(rs.getString("english"))+Integer.parseInt(rs.getString("hindi"))+Integer.parseInt(rs.getString("computer"));
                                                                            out.println(tot);
                                                                            double per=tot/5;
                                                                            %></th>
                                                                        <th></th>
