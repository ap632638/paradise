<%-- 
    Document   : header
    Created on : 3 Oct, 2019, 10:23:37 PM
    Author     : Arun
--%>
...
<html lang="en">
  <head>
    ...
    <title><% ServletContext sc=getServletContext(); 
                                                                                out.println(sc.getInitParameter("scname")); %></title>
          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="stulogin.jsp">Student Login</a></li>                
                <li><a href="teachlogin.jsp">Teacher Login</a></li>                
              </ul>
            </li>           
            <li><a href="/paradise/gallery">Gallery</a></li>
           <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="blog-archive.jsp">Blog Archive</a></li>                
